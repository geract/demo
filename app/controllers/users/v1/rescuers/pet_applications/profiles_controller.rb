class Users::V1::Rescuers::PetApplications::ProfilesController < Users::V1::Rescuers::BaseController
  def show
    pet_application = current_organization.pet_applications.includes(adopter_profile: [:adopter, :address, :references, {employment: :address}]).find(safe_params[:pet_application_id])
